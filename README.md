...
Each tasks as it's own assigned previous_time and a set delay, and will only execute when the elapsed time as passed. After which, the assiciated previous_time is reset to the current_time holded by millis().
